...
import com.selectcity.citywheelview.OnWheelChangedListener;
import com.selectcity.citywheelview.OnWheelScrollListener;
import com.selectcity.citywheelview.WheelView;
import com.selectcity.citywheelview.adapter.AbstractWheelTextAdapter1;
...
public class SelectAddressPopWindow extends PopupWindow implements View.OnClickListener {
    ...
    private String strProvince = "辽宁";
    private String strCity = "沈阳";
    private String strArea = "和平区";
...
//        View view = View.inflate(context, R.layout.edit_changeaddress_pop_layout, null);
        View view = View.inflate(context, R.layout.edit_changeaddress_pop_layout_new, null);
...
//			dismiss();
    ...
    public void initCitys(String[] citys) {
        if (citys != null) {
            ...
            String[] city = mCitisDatasMap.get("辽宁");
            arrCitys.clear();
...
//            String[] area = mAreaDatasMap.get("沈阳");
//            arrAreas.clear();
