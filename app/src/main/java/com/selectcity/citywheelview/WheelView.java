...
package com.selectcity.citywheelview;
...
import com.selectcity.R;
import com.selectcity.citywheelview.adapter.WheelViewAdapter;
...
//		int offset = 60;
        ...
        paint.setColor(Color.parseColor("#71c601"));
        // 设置线宽
//		paint.setStrokeWidth((float) 3);
        paint.setStrokeWidth((float) 1);

        int space = getResources().getDimensionPixelSize(R.dimen.dimen30dp);
        // 绘制上边直线
        canvas.drawLine(space, center - offset, getWidth() - space, center - offset, paint);
        canvas.drawLine(space - 1, center - offset - 1, getWidth() - space, center - offset - 1, paint);
        canvas.drawLine(space - 1, center - offset - 2, getWidth() - space, center - offset - 2, paint);
        canvas.drawLine(space - 1, center - offset - 3, getWidth() - space, center - offset - 3, paint);
        // 绘制下边直线
        canvas.drawLine(space, center + offset, getWidth() - space, center + offset, paint);
        canvas.drawLine(space + 1, center + offset + 1, getWidth() - space, center + offset + 1, paint);
        canvas.drawLine(space + 1, center + offset + 2, getWidth() - space, center + offset + 2, paint);
